...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "Question create" do
    it "increases the number of Questions by 1" do
      expect{post :create, question: {title:
        RandomData.random_sentence, body: RandomData.random_paragraph}}.to change(Question,:count).by(1)
    end
    ...
    it "redirects the new questions" do
      post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
  ...
  describe "Put update" do
    it "updates question with expected attriubutes" do
